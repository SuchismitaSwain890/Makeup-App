...
public class TinyDB {
    ...
    public ArrayList<MakeupDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<MakeupDomain> playerList =  new ArrayList<MakeupDomain>();

        for(String jObjString : objStrings){
            MakeupDomain player  = gson.fromJson(jObjString,  MakeupDomain.class);
    ...
    public void putListObject(String key, ArrayList<MakeupDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(MakeupDomain player: playerList){
