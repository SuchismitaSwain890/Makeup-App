...
import com.example.androiappm.Activity.ShowDetailActivity;
...
public class RecommendedAdapter extends RecyclerView.Adapter<RecommendedAdapter.ViewHolder> {
    ArrayList<MakeupDomain> RecommendedDomains;

    public RecommendedAdapter(ArrayList<MakeupDomain> RecommendedDomains) {
